...
def main():
    ...
    print(" Rebus Generation Package - Basic Example non-reasoning")
    print("=" * 50)
    ...
    try:
        ...
        puzzles = offline_generation.generate_bank_non_reasoning(
            domains=domains,
            words=words,
        ...
        # Display results
        print("\n Generated Puzzles:")
        puzzles.to_json("offline_generation_non_reasoning.json")
        print("=" * 50)
